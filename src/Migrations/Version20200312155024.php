 ...
 */
final class Version20200312155024 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, ticketid_id INT NOT NULL, userid_id INT NOT NULL, content LONGTEXT NOT NULL, time DATETIME NOT NULL, INDEX IDX_B6BD307F10BAFB74 (ticketid_id), INDEX IDX_B6BD307F58E0A285 (userid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, customerid_id INT NOT NULL, agentid_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, content VARCHAR(255) NOT NULL, status INT NOT NULL, priority INT NOT NULL, time DATETIME NOT NULL, INDEX IDX_97A0ADA376F04A3B (customerid_id), INDEX IDX_97A0ADA38FFA54AF (agentid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, question VARCHAR(255) NOT NULL, time DATETIME NOT NULL, repoenedtickets INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
